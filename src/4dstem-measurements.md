...
- Converged electron probe ${tex`\hat{\mathcal{P}}`} scanned across thin-sample ${tex`\hat{\mathcal{O}}`}, acquiring phase-shifts
- Diffracted beam _intensity_ ${tex`\left\{ I \right\}`} collected on far-field pixelated detector
